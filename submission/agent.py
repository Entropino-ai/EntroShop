"""TechJam Conversational Search — Shopping Copilot Agent (submission entry).

Official submission layout: agent.py (this file) + src/ + requirements.txt +
README.md. Requires the frozen catalog and the organizer's local evaluator
(see README.md). Fully offline deterministic core; LLM rerank optional.
